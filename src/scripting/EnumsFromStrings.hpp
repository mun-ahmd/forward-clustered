...
#include "scripting/EnumStringConversionBase.hpp"

namespace Rendering {
    inline static std::unordered_map<std::string, VkAttachmentLoadOp> VkAttachmentLoadOpMap = {
	...
	inline VkAttachmentLoadOp attachmentLoadOpFromString(std::string enumName) {
	    return getEnumFromString(VkAttachmentLoadOpMap, enumName);
	}
	inline static std::unordered_map<std::string, VkAttachmentStoreOp> VkAttachmentStoreOpMap = {
	...
	inline VkAttachmentStoreOp attachmentStoreOpFromString(std::string enumName) {
	    return getEnumFromString(VkAttachmentStoreOpMap, enumName);
	}
	inline static std::unordered_map<std::string, VkBorderColor> VkBorderColorMap = {
	...
	inline VkBorderColor borderColorFromString(std::string enumName) {
	    return getEnumFromString(VkBorderColorMap, enumName);
	}
	inline static std::unordered_map<std::string, VkCompareOp> VkCompareOpMap = {
	...
	inline static std::unordered_map<std::string, VkDescriptorType> VkDescriptorTypeMap = {
	...
	inline static std::unordered_map<std::string, VkFilter> VkFilterMap = {
	...
	inline VkFilter filterFromString(std::string enumName) {
	    return getEnumFromString(VkFilterMap, enumName);
	}
	inline static std::unordered_map<std::string, VkFormat> VkFormatMap = {
	...
	inline static std::unordered_map<std::string, VkImageAspectFlags> VkImageAspectFlagBitsMap = {
	...
	inline VkImageAspectFlags imageAspectFlagsFromString(std::string enumName) {
	    return getBitFlagsFromString(VkImageAspectFlagBitsMap, enumName);
	}
	inline static std::unordered_map<std::string, VkImageLayout> VkImageLayoutMap = {
	...
	inline VkPipelineStageFlags pipelineStageFlagsFromString(std::string enumName) {
	    return getBitFlagsFromString(VkPipelineStageFlagBitsMap, enumName);
	}
	inline static std::unordered_map<std::string, VkPolygonMode> VkPolygonModeMap = {
	...
	inline static std::unordered_map<std::string, VkSamplerAddressMode> VkSamplerAddressModeMap = {
	...
	inline VkSamplerAddressMode samplerAddressModeFromString(std::string enumName) {
	    return getEnumFromString(VkSamplerAddressModeMap, enumName);
	}
	inline static std::unordered_map<std::string, VkSamplerCreateFlags> VkSamplerCreateFlagBitsMap = {
	...
	inline VkSamplerCreateFlags samplerCreateFlagsFromString(std::string enumName) {
	    return getBitFlagsFromString(VkSamplerCreateFlagBitsMap, enumName);
	}
	inline static std::unordered_map<std::string, VkSamplerMipmapMode> VkSamplerMipmapModeMap = {
		{"nearest", VK_SAMPLER_MIPMAP_MODE_NEAREST},
		{"linear", VK_SAMPLER_MIPMAP_MODE_LINEAR},
		{"maxEnum", VK_SAMPLER_MIPMAP_MODE_MAX_ENUM}
	};
	inline VkSamplerMipmapMode samplerMipmapModeFromString(std::string enumName) {
	    return getEnumFromString(VkSamplerMipmapModeMap, enumName);
	}
	inline static std::unordered_map<std::string, VkShaderStageFlags> VkShaderStageFlagBitsMap = {
